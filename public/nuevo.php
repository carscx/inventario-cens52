...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (!in_array($estado, ['operativo', 'en_reparacion', 'baja', 'stock'], true))
  ...
  if ($precio === null && ($_POST['precio_unitario'] ?? '') !== '')
  ...
  <main class="app-container">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <fieldset>
        ...
        <label>Precio unitario<input type="number" name="precio_unitario" step="0.01" min="0"
            value="<?= h($_POST['precio_unitario'] ?? '') ?>"></label>
        <label>Responsable<input name="responsable" maxlength="160"
            value="<?= h($_POST['responsable'] ?? '') ?>"></label>
